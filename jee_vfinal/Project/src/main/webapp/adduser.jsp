...
<html>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Ajout</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="ad" class="signin-form" method="get">
  ...
  required>
	            ...
	            <div class="form-group">
	            <input type="radio" name="role" value="etudiant"  required/>           <label>  etudiant</label>
	            <br>
	         <input type="radio" name="role" value="professeur"  required/>           <label>  professeur</label>
